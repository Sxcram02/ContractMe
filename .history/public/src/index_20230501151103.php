                ...
                <section class="GRP4-section" id="GRP4-section1">
                    ...
                    <article class="GRP4-articles" id="GRP4-articleHome">
                        ...
                        <div class="GRP4-box-enviar">
                            <input type="submit" value="Enviar" id="" class="GRP4-inputs GRP4-sent">
                            <input type="submit" value="Cerrar Sesión" name="logOut" id="GRP4-sent"
                                class="GRP4-inputs GRP4-sent" style="background-color: red; padding:1%;" />
                        </div>
                    </article>
