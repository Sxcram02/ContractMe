        ...
        < </header>
            <main id="GRP4-main">
                ...
                <div id="GRP4-box-content">
                    <form id="GRP4-formulario-signIn">
                        <section class="GRP4-section" id="GRP4-section1">
                            ...
                            <article class="GRP4-articles" id="GRP4-articleDate">
                                ...
                                <input id="Fecha" type="date" name="Fechadenacimiento" placeholder="Fecha"
                                    class="GRP4-inputs">
                            ...
                            <article class="GRP4-articles" id="GRP4-articleUser">
                                ...
                                <input type="text" id="repetir" name="repetirContraseña"
                                    placeholder="Repetir Contraseña" class="GRP4-inputs">
                            </article>

                            <article class="GRP4-articles" id="GRP4-articleHome">
                                <input type="number" id="codigo" class="GRP4-inputNumber GRP4-inputs"
                                    name="codigoPostal" placeholder="CP">
                                ...
                                <div class="enviar">
                                    <input type="submit" value="Enviar" id="GRP4-sent" class="GRP4-inputs">
                                </div>
                            </article>
                    ...
                    <section class="GRP4-section" id="GRP4-section2">
                            ...
                            <div id="contenedorExperiencia">
                                ...
                                <div class="contenedorInputs">
                                    ...
                                    <input type="date" id="fecha" name="fechaFinalExperiencia" placeholder="2019"
                                        class="GRP4-inputs">
                                    <input type="text" id="descripcion" name="descripcionExperiencia"
                                        placeholder="Descripción" class="GRP4-inputs">
                                </div>
                        ...
                        <article class="GRP4-articles" id="GRP4-education">
                            ...
                            <div id="contenedorFormacion">
                                ...
                                <div class="contenedorInputs">
                                    <input type="number" class="fechaFormacion GRP4-inputs" placeholder="Año inicio"
                                        min="1900">
                                    <input type="number" class="fechaFormacion GRP4-inputs" placeholder="Año fin"
                                        min="1900">
                                    <input type="text" class="fechaFormacion GRP4-inputs"
                                        placeholder="Curso autoformación">
                                </div>
                        ...
                        <article class="GRP4-articles" id="GRP4-idioms">
                            ...
                            <div id="contenedorIdiomas">
                                ...
                                <div class="contenedorInputs">
                                    ...
                                    <input type="text" class="optionIdiom GRP4-inputs" name="idioma"
                                        placeholder="Idioma">
