<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if(isset($userEmailLogin) and isset($userPassLogin) and $valueOption == "Iniciar Sesion") {    
            getAccount($valueOption, $userEmailLogin,$userPassLogin);
            $_SESSION['user']= $userEmailLogin;
            echo "HOLAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA</h1>";
            exit();
        }

        if(!isset($userEmailLogin) and !isset($userPassLogin) and $valueOption == "Crear cuenta"){
