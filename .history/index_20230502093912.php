<?php
    ...
    if($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        (!empty($userEmailLogin) and !empty($userPassLogin) and $valueOption == "Iniciar Sesion")?{getAccount($valueOption, $userEmailLogin,$userPassLogin)
            $_SESSION['user']= $userEmailLogin
            exit()
        } elseif(empty($userEmailLogin) and empty($userPassLogin) and $valueOption = "Crear cuenta"){
